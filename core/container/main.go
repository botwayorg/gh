...
import (
	...
	"github.com/botwayorg/gh/core/build"
	...
	"github.com/botwayorg/gh/core/update"
...
func mainRun() exitCode {
	...
	if cmd, err := rootCmd.ExecuteC(); err != nil {
		...
		if strings.Contains(err.Error(), "Incorrect function") {
			...
			fmt.Fprintln(stderr, "To learn about workarounds for this error, run botway help mintty")
			return exitError
		}
