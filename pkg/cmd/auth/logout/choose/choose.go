...
func (m model) View() string {
	...
	return questionStyle.Render("?") + titleStyle.Render(" What account do you want to log out of?") + "\n" + m.list.View()
}

func Choose(candidates []string) (string, error) {
	items := []list.Item{}
	...
	fmt.Println(lipgloss.NewStyle().Bold(true).SetString("Account to log out: ").String() + account)
