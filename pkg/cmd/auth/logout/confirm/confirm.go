...
func (m model) View() string {
	...
	return questionStyle.Render("?") + titleStyle.Render(fmt.Sprintf(" Are you sure you want to log out of %s%s?", host, username)) + "\n" + m.list.View()
}

func ConfirmLogout(hostname, un string) (bool, error) {
	host = hostname
	username = un
	...
	fmt.Println(lipgloss.NewStyle().Bold(true).SetString("Confirm Logout: ").String() + s)
